...
Welcome to the central workspace for our curriculum update workgroup. This repository tracks our collaborative efforts to modernize the Web Developer program, officially transitioning it to the **AI-Skilled Web Developer** program (CIP 11.0104 - Informatics).
...
*   **[`cit82-intro-ai-web-dev.md`](courses/cit82-intro-web-dev.md):** 🚧 **NEXT TASK:** Drafting SLOs and Course Description.
...
*   **[`cit94-ai-workflows.md`](courses/cit94-ai-workflows.md):** 📅 Final Capstone draft.

---

## 🧠 Core Pedagogy: The "Mechanical Shop"
We are training students to navigate an **AI-Augmented Career Ecosystem**.
1.  **Foundational Mastery:** Manual authoring of code to understand "under-the-hood" mechanics.
2.  **AI Orchestration:** Using LLMs for debugging, explanation, and efficiency—not primary generation.
3.  **Verifiable Competency:** Performance-based mastery via **Verbal Code Reviews** and **Technical Interviews**.
